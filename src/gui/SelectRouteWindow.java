...
public class SelectRouteWindow {
	...
	private void initialize(Game game, Island destination) {
		...
		JLabel lblChooseAnIsland = new JLabel("Select a route to use");
		...
		MapRoute mapRoute = this.findMapImage(destination, player, safeRoute, dangerousRoute);
		...
		btnSetSail.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent f) {
				...
				if (routeSelectSuccess) {
					...
					if (checkRoute && confirmSailing(destination.getName(), selectedRoute.getName(), selectedRoute.getCost(ship))) {
	...
	private boolean confirmSailing(String destination, String route, int cost) {
